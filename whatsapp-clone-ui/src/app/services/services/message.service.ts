...
import { saveMessages } from '../fn/message/save-messages';
import { SaveMessages$Params } from '../fn/message/save-messages';
...
export class MessageService extends BaseService {
  ...
  /** Path part for operation `saveMessages()` */
  static readonly SaveMessagesPath = '/api/v1/messages';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `saveMessages()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  saveMessages$Response(params: SaveMessages$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
    return saveMessages(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `saveMessages$Response()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  saveMessages(params: SaveMessages$Params, context?: HttpContext): Observable<void> {
    return this.saveMessages$Response(params, context).pipe(
